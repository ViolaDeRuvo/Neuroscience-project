...
print("Max Value of ER_post")
index_titti = np.argmin(np.abs(brate_post[:, 0] - 20))
value_titti = brate_post_meanER[index_titti]
print(value_titti)
...
print("Max Vlue of BP")
print(np.nanmax(100*brate_post_meanBP))
...
print("Max value of DW")
print(np.nanmax(100*(wsum_mean - wsum_mean[0])/wsum[0, 1]))
...
ax2.set_ylabel('[%]')
ax2.legend(loc='lower left', bbox_to_anchor=(1, 1.05))
...
print("Max value of ER_pre")
print(np.nanmax(brate_pre_meanER))
